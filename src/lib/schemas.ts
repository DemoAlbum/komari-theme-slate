...
export const themeSettingsSchema = z
  .object({
    ...
    showTableName: z.boolean().optional().default(true),
    showTableStatus: z.boolean().optional().default(true),
    showTableSystem: z.boolean().optional().default(true),
    showTableUptime: z.boolean().optional().default(true),
    showTableCpu: z.boolean().optional().default(true),
    showTableMemory: z.boolean().optional().default(true),
    showTableDisk: z.boolean().optional().default(true),
    showTableSpeed: z.boolean().optional().default(true),
    showTableTraffic: z.boolean().optional().default(true),
